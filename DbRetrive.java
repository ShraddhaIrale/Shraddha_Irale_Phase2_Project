...
import com.la.project.Student;
import com.la.project.Subject;
import com.la.project.Teacher;
import com.la.project.Class;
	...
	public List<Teacher> getTeachers() {
		...
		try {
			...
			while (myRs.next()) {
				...
				// create new student object
				Teacher temp = new Teacher(id, fname, lname, age);
